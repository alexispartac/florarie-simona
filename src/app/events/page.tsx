...
export default function EventsListPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div
        className="bg-linear-to-r from-primary to-primary-200 text-white my-20"
        style={{
      ...
      >
        <div className="max-w-7xl mx-auto text-gray-800 px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">Evenimente</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        {isLoading ? (
              ...
              >
                ...
                <div className="relative h-64 bg-gray-100">
                  ...
                  <div className="absolute top-4 right-4 flex flex-col gap-2">
                    {event.featured && (
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold bg-yellow-400 text-yellow-900 shadow-lg">
          ...
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">Nu există evenimente</h3>
